        ...
        <div class="p-6">
            <nav class="space-y-2">
                ...
                <a href="<?= BASEURL; ?>/dashboard"
                    ...
                    :class="currentPath.endsWith('/dashboard') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-50'">
                    <div class="w-10 h-10 flex items-center justify-center rounded-lg transition-all duration-300"
                        :class="currentPath.endsWith('/dashboard') ? 'bg-blue-100 text-blue-600' : 'bg-gray-50 text-gray-600 group-hover:bg-gray-100'">
                ...
                <a href="<?= BASEURL; ?>/dashboard/createpost"
                    class="flex items-center gap-3 py-2.5 px-4 rounded-xl transition-all duration-300 group"
                    :class="currentPath.endsWith('/dashboard/createpost') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-50'">
                    <div class="w-10 h-10 flex items-center justify-center rounded-lg transition-all duration-300"
                        :class="currentPath.endsWith('/dashboard/createpost') ? 'bg-blue-100 text-blue-600' : 'bg-gray-50 text-gray-600 group-hover:bg-gray-100'">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                d="M12 4v16m8-8H4" />
                        </svg>
                ...
                <a href="<?= BASEURL; ?>/dashboard/posts"
                    class="flex items-center gap-3 py-2.5 px-4 rounded-xl transition-all duration-300 group"
                    :class="currentPath.endsWith('/dashboard/posts') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-50'">
                    <div class="w-10 h-10 flex items-center justify-center rounded-lg transition-all duration-300"
                        :class="currentPath.endsWith('/dashboard/posts') ? 'bg-blue-100 text-blue-600' : 'bg-gray-50 text-gray-600 group-hover:bg-gray-100'">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                ...
                <a href="<?= BASEURL; ?>/dashboard/profile"
                    class="flex items-center gap-3 py-2.5 px-4 rounded-xl transition-all duration-300 group"
                    :class="currentPath.endsWith('/dashboard/profile') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-50'">
                    <div class="w-10 h-10 flex items-center justify-center rounded-lg transition-all duration-300"
                        :class="currentPath.endsWith('/dashboard/profile') ? 'bg-blue-100 text-blue-600' : 'bg-gray-50 text-gray-600 group-hover:bg-gray-100'">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
    ...
    <div class="lg:ml-64 min-h-screen bg-gray-50">
        ...
        <main class="p-4 sm:p-6 lg:p-8 pt-28 mb-6">
            ...
            if (isset($content)) {
                ...
                echo "<p>Error: Tidak ada konten yang ditampilkan.</p>";
            }
            ?>
        </main>
    </div>
